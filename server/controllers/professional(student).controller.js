require('../models/professional(student).model');
...
module.exports.register = (req, res, next) => {
    ...
    professional.user_id = req.body.user_id;
    ...
    var transporter = nodemailer.createTransport({
        service: 'Gmail',
        auth: {
            user: 'caramelitacademy1@gmail.com',
            pass: 'Caramel_IT1'
        }
    });
    var mailOptions = {
        to: professional.emailAddress,
        from: 'caramelitacademy1@gmail.com',
        subject: 'CaramelIT Registration Successful',
        text: 'Hey There,'+'\n\n'+'\t'+'Thanks for registering to Caramel IT Academy. We are thrilled to have you here.'+
                '\n\n'+'You can visit us at https://caramelit.com/. If you have any queries or problems, mail us at caramelitacademy1@gmail.com. We are more than happy to help you out.'
    }
